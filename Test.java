...
public class Test {
	...
	Test_Monom();
		...
		Test_Polynom();
		System.out.println(Math.round(-14.040000000000001*100.0)/100.0);
		
		Polynom p=new Polynom("0.2x^4-1.5x^3+3x^2-x-5");
		//p.toPlot(-2, 6);
		System.out.println(p.underArea(-2, 6, 0.04));
		System.out.println(p.area(-2, 6, 0.04));
		System.out.println(p.aboveArea(-2, 6, 0.04));
