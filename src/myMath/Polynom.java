...
public class Polynom implements Polynom_able{
	...
	public boolean equals (Polynom_able p1) throws Exception{
		...
		// While both Polynoms still have Monoms
	...
	public double root(double x0, double x1, double eps) throws Exception {
		...
		// All the values are legal
			...
			while ( (x1-x0) > eps )
			{
				...
				// f(x0) and f(mid) have different signs
	...
	public Polynom_able derivative() throws Exception{
		...
		while (p_iter.hasNext() ) {
			Monom current=p_iter.next();
			// Checking if the Monom is not a free number
	...
	public double area(double x0,double x1, double eps) throws Exception {
		// Count the area above and under the X axis and the Polynom
	 ...
	 * @throws Exception
	 */
	private boolean xaxis(double x0,double x1,double eps) throws Exception {
		boolean flag=false;
	 ...
	 * Given a Polynom and range the method draws a new plot
